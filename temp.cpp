...
class cItem { public:
cItem(string nazwa) { this->nazwa = nazwa; } string nazwa;
};
class cBohater { double hp,mana; cItem* p[MAX_ITEMS]; public:
cBohater() { hp = 1; mana = 1; for(int i=0;i<MAX_ITEMS;++i) { p[i] = NULL; }
}
~cBohater()
{
